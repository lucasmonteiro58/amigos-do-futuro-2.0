...
export const badges_texts = {
  sau: {
    ...
    description:
      'Adora cuidar de outras pessoas, tem muita coragem para salexport const vidas e é muito amável.'
  },
  laz: {
    id: 'laz',
    color: '#D87100',
...
export const matrix_questions_pont = [
  [3, 2, -1, -2, -3, 1, 0],
  [1, 3, -2, -1, 2, 0, -3],
  [-3, 1, 3, 2, 0, -1, -2],
  [-2, 0, 1, 3, -1, -3, 2],
...
export const map_regions_texts = [
  {
