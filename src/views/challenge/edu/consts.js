export const featuresOne = [
  {
    key: 'accessibility',
    text: 'Facilidade para quem usa cadeira de rodas',
  ...
  },
  {
    ...
    images: [
      ...
      { src: 'escolaf_arvores2', class: 'absolute bottom-[390px] right-[-20px]' }
    ]
  },
  {
    key: 'bus',
    text: 'Mais aulas pela cidade',
  ...
  {
    key: 'garden',
    text: 'Alimentos colhidos na horta',
...
export const postionsTwo = [
  'bottom-[592px] left-[448px]',
  'bottom-[360px] left-[448px]',
  'bottom-[685px] scale-[0.93]',
  'bottom-[592px] left-[1165px]',
  'bottom-[360px] left-[1162px]'
]
...
export const featuresTwo = [
  ...
  },
  {
    ...
    normalIcon: 'escolad_bt_teatro',
    images: [{ src: 'escolad_salateatro' }]
  },
  {
    key: 'canteen',
    ...
    normalIcon: 'escolad_bt_cantina',
    images: [{ src: 'escolad_cantina' }]
  },
  {
    key: 'music',
    text: 'Muitos músicos',
    ...
    normalIcon: 'escolad_bt_musica',
    images: [{ src: 'escolad_salamusica' }]
  },
  {
    key: 'computer',
    ...
    normalIcon: 'escolad_bt_informatica',
    images: [{ src: 'escolad_labinformatica' }]
  },
  {
    key: 'science',
    ...
    normalIcon: 'escolad_bt_quimica',
    images: [{ src: 'escolad_labciencias' }]
  },
  {
    key: 'dance',
    ...
    normalIcon: 'escolad_bt_danca',
    images: [{ src: 'escolad_saladanca' }]
  }
]
...
export const featuresThree = [
  {
    key: 'chair',
    text: 'Lugares confortáveis para escrever',
    normalIcon: 'bt_carteira',
    checkedIcon: 'bt_carteira_check',
    minusIcon: 'bt_carteira_menos',
    addIcon: 'bt_carteira_add',
    saveIcon: 'bt_carteira',
    images: [{ src: 'sala_carteirassala', class: 'absolute bottom-[0px] left-[385px]' }]
  },
  {
    key: 'books',
    text: 'Livros com muita aventura',
    normalIcon: 'bt_livros',
    checkedIcon: 'bt_livros_check',
    minusIcon: 'bt_livros_menos',
    addIcon: 'bt_livros_add',
    saveIcon: 'bt_livros',
    images: [{ src: 'sala_livrossala', class: 'absolute bottom-[570px]  left-[795px] scale-[0.8]' }]
  },
  {
    key: 'pencil',
    text: 'Lápis de todas as cores',
    normalIcon: 'bt_lapis',
    checkedIcon: 'bt_lapis_check',
    minusIcon: 'bt_lapis_menos',
    addIcon: 'bt_lapis_add',
    saveIcon: 'bt_lapis',
    images: [{ src: 'sala_lapissala', class: 'absolute bottom-[600px] right-[420px] scale-[0.6]' }]
  },
  {
    key: 'square',
    text: 'Onde o professor escrever',
    normalIcon: 'bt_quadro',
    checkedIcon: 'bt_quadro_check',
    minusIcon: 'bt_quadro_menos',
    addIcon: 'bt_quadro_add',
    saveIcon: 'bt_quadro',
    images: [{ src: 'sala_quadrosala', class: 'absolute bottom-[650px] left-[660px]' }]
  },
  {
    key: 'globe',
    text: 'Onde ver todos os países',
    normalIcon: 'bt_globo',
    checkedIcon: 'bt_globo_check',
    minusIcon: 'bt_globo_menos',
    addIcon: 'bt_globo_add',
    saveIcon: 'bt_globo',
    images: [{ src: 'sala_globosala', class: 'absolute bottom-[785px] left-[310px]' }]
  },
  {
    key: 'trash',
    text: 'Chão limpo sempre',
    normalIcon: 'bt_lixo',
    checkedIcon: 'bt_lixo_check_1',
    minusIcon: 'bt_lixo_menos_1',
    addIcon: 'bt_lixo_add_1',
    saveIcon: 'bt_lixo',
    images: [{ src: 'sala_lixeirasala', class: 'absolute bottom-[250px] left-[1740px]' }]
  },
  {
    key: 'lamp',
    text: 'Iluminação boa',
    normalIcon: 'bt_lampada',
    checkedIcon: 'bt_lampada_check',
